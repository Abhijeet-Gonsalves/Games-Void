  ...
  <body data-spy="scroll" data-target="#my_nav">
    ...
    <div class="container ban">
        <div class="row banner justify-content-center">
            <div class="col-lg-10 col-md-10 text-center">
                <div class="back">
                    <a href="store.php"><span class="pr-2"><i class="fas fa-arrow-left pr-2"></i>Go Back to Store</span><pre> |  Prince Of Persia: Warrior Within</pre></a>
                </div>  
            </div>
        </div>
    ...
    <div class="container">
        <div class="row vid justify-content-center">
            ...
            <div class="col-lg-8 col-md-8">
                <iframe width="720" height="420" src="https://www.youtube.com/embed/PYg22f3p3aI" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
        <div class="row vid justify-content-center">
            <div class="col-lg-2 col-md-2">
            ...
            <div class="col-lg-8 col-md-8">
                <img class="screenshot img-fluid" src="images/wwss0.png">
            </div>
                ...
                <div class="accordion" id="accordionExample">
                  <div class="card">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                          <div class="card-img">
                            <img class="screenshot img-fluid" src="images/wwss1.png">
                          </div>
                          <div class="card-img">
                            <img class="screenshot img-fluid" src="images/wwss2.png">
                          </div>
                          <div class="card-img">
                            <img class="screenshot img-fluid" src="images/wwss3.png">
                          </div>
                          <div class="card-img">
                            <img class="screenshot img-fluid" src="images/wwss4.png">
                          </div>
                          <div class="card-img">
                            <img class="screenshot img-fluid" src="images/wwss5.png">
                          </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="image text-center">
                  <img class="img-fluid cover" src="images/wwpop.png">
      ...
      <div class="row">
          <div class="col-lg-12">
            <div class="copy text-center">
              <p><small>Copyright &copy; 2020. All Rights Reserved | This template is made by <span style="color: #EE2929;">Abhijeet Gonsalves</span></small></p>
            </div>
          </div>  
        </div>
    </div>
