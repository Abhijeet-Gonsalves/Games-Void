  ...
  <body data-spy="scroll" data-target="#my_nav">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto mb-2 mb-lg-0 p-1">
            <li class="nav-item pl-2 pr-2">
              <a class="nav-link js-scroll-trigger active" aria-current="page" href="store#hero">Store</a>
            </li>
            <li class="nav-item js-scroll-trigger pl-2 pr-2">
              <a class="nav-link" href="store#new">New Releases</a>
            </li>
            <li class="nav-item js-scroll-trigger pl-2 pr-2">
              <a class="nav-link" href="store#free">Free Games</a>
            </li>
            <li class="nav-item js-scroll-trigger pl-2 pr-2">
              <a class="nav-link" href="store#trend">Trending Gams</a>
            </li>
            <li class="nav-item js-scroll-trigger pl-2 pr-2">
              <a class="nav-link" href="store#upcom">Upcomeing</a>
            </li>
            <li class="nav-item js-scroll-trigger pl-2 pr-2">
              <a class="nav-link" href="store#sale">On Sale</a>
            </li>
            <li class="nav-item js-scroll-trigger pl-2 pr-2">
    ...
    <div class="container ban">
        <div class="row banner justify-content-center">
            <div class="col-lg-10 col-md-10 text-center">
                <div class="back">
                    <a href="store.php"><span class="pr-2"><i class="fas fa-arrow-left pr-2"></i>Go Back to Store</span><pre> |  Ghost Runner</pre></a>
                </div>  
            </div>
        </div>
            ...
            <div class="col-lg-7 col-md-12">
                <div class="intro">
                    ...
                    <div class="btn-group" role="group">
                        <button type="button" class="btn btn-dark" data-toggle="modal" data-target="#staticBackdrop">Pre-Purchase</button>
    ...
    <div class="container">
        <div class="row vid justify-content-center">
            ...
            <div class="col-lg-8 col-md-8">
                <iframe width="720" height="420" src="https://www.youtube.com/embed/b70uw0XxeLg" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
        <div class="row vid justify-content-center">
            <div class="col-lg-2 col-md-2">
            ...
            <div class="col-lg-8 col-md-8">
                <img class="screenshot img-fluid" src="images/ghostss0.png">
            </div>
                ...
                <div class="accordion" id="accordionExample">
                  <div class="card">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                          <div class="card-img">
                            <img class="screenshot img-fluid" src="images/ghostss1.png">
                          </div>
                          <div class="card-img">
                            <img class="screenshot img-fluid" src="images/ghostss2.png">
                          </div>
                          <div class="card-img">
                            <img class="screenshot img-fluid" src="images/ghostss3.png">
                          </div>
                          <div class="card-img">
                            <img class="screenshot img-fluid" src="images/ghostss4.png">
                          </div>
                          <div class="card-img">
                            <img class="screenshot img-fluid" src="images/ghostss5.png">
                          </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                <div class="image text-center">
                  <img class="img-fluid cover" src="images/ghost.png">
                  <h4>Ghost Runner</h4>
                </div>
                <div id="myProgress">
                  <div id="myBar">10%</div>
      ...
      <div class="row">
          <div class="col-lg-12">
            <div class="copy text-center">
              <p><small>Copyright &copy; 2020. All Rights Reserved | This template is made by <span style="color: #ff00ff;">Abhijeet Gonsalves</span></small></p>
            </div>
          </div>  
        </div>
    </div>
