  ...
  <body data-spy="scroll" data-target="#my_nav">
    ...
    <div class="container ban">
        <div class="row banner justify-content-center">
            <div class="col-lg-10 col-md-10 text-center">
                <div class="back">
                    <a href="store.php"><span class="pr-2"><i class="fas fa-arrow-left pr-2"></i>Go Back to Store</span><pre> |  Assassin's Creed Valhalla</pre></a>
                </div>  
            </div>
        </div>
        <div class="row poster">
            <div class="col-lg-4 col-md-12">
                <div class="card">
                    <div class="card-img">
                       <img src="images/assassinsvh.png">
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row vid justify-content-center">
            ...
            <div class="col-lg-8 col-md-8">
                <iframe width="720" height="420" src="https://www.youtube.com/embed/ssrNcwxALS4" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
            </div>
        </div>
        <div class="row vid justify-content-center">
            <div class="col-lg-2 col-md-2">
            ...
            <div class="col-lg-8 col-md-8">
                <img class="screenshot img-fluid" src="images/creedvhss0.png">
            </div>
                ...
                <div class="accordion" id="accordionExample">
                  <div class="card">
                        ...
                        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                          <div class="card-img">
                            <img class="screenshot img-fluid" src="images/creedvhss1.png">
                          </div>
                          <div class="card-img">
                            <img class="screenshot img-fluid" src="images/creedvhss2.png">
                          </div>
                          <div class="card-img">
                            <img class="screenshot img-fluid" src="images/creedvhss3.png">
                          </div>
                          <div class="card-img">
                            <img class="screenshot img-fluid" src="images/creedvhss4.png">
                          </div>
                          <div class="card-img">
                            <img class="screenshot img-fluid" src="images/creedvhss5.png">
                          </div>
                        </div>
                    </div>
                </div>
