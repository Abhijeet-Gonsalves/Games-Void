           ...
           <ul id="games_slider_content">
            <li>
             ...
             <li>
               <div class="card">
                 <div class="card-img">
                   <a href="game.php"><img src="images/assassinsvh.png"></a>
     ...
     <div class="row justify-content-center">
       <div class="col-lg-11 col-md-11 free">
        <div class="text-left left">
          ...
          <div class="red-neon">
            <a href="warrior.php">Get FREE Now</a>
          </div>
        </div>
     ...
     <div class="row justify-content-center">
       <div class="col-lg-11 col-md-11 upcom">
        <div class="text-left upcom-left">
          ...
          <div class="pink-neon">
            <a href="ghost.php">Pre Purchase</a>
          </div>
        </div>
       ...
       <div class="col-lg-11 col-md-11 sale">
         <div class="text-left sale-left">
            <h4 class="sale-title">
              ...
              <a class="btn btn-outline-light btn-sm" href="#">View more</a>
            </h4>
          </div>
    ...
    <div id="other" class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-lg-11 col-md-11 brow">
          ...
          <div class="blue-neon">
            <a href="allgame.php">Browse-All</a>
          </div>
